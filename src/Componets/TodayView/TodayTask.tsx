  ...
  return (
    ...
    <div className='h-full w-3/5 flex items-center justify-around flex-col'>
      ...
      <div className='w-full h-full flex flex-col items-center justify-around'>
          <p className='text-2xl font-medium text-white'>{task.Description}</p>
          <p className='text-lg font-medium text-white'>sadsadsadsadsadsadasdsadsdasda</p>
      </div>
